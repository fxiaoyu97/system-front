<template>
  <div class="app-container">
    <el-form label-width="120px" size="small">
      ...
      <div style="background-color:#E0E0E0;width: 100%;padding: 0 10px;margin: 10px 0;">
        <h3>基本信息</h3>
      </div>
      <div style="background-color:#E0E0E0;width: 100%;padding: 0 10px;margin: 10px 0;">
        <h3>宣传图片</h3>
      ...
      <el-form-item label="上传图片">
        <el-upload :on-success="onUploadPosterSuccess" :before-upload="beforeUpload" :on-preview="onUploadPreview"
          :on-remove="onUploadPosterRemove" :multiple="true" :action="BASE_API + '/admin/product/fileUpload'"
          class="upload-demo" list-type="picture-card" :file-list="filePosterList">
